...
const Characters = () => {
  ...
  return (
    <div className="mx-4 my-4">
      <h1 className="text-4xl font-bold text-yellow-600 text-center mb-10 py-4">
        Characters
      </h1>
      <div
        className="character-content mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5"
      >
